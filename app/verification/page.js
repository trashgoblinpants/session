  ...
  return (
    ...
    <div className="mt-5">
      ...
      <div className="flex items-center justify-center w-100 mt-3">
        <button id="human-safeguard" className="w-full px-3 py-3 my-4 font-mono text-base rounded text-telegram-button-text bg-gradient-to-r from-[#385446] via-[#366950] to-[#3c7659] hover:bg-gradient-to-br shadow-lg shadow-black-500/50 dark:shadow-lg dark:shadow-black-800/80" onClick={handleVerification}>
